...
module parallel_3d
  ...
  public :: mod_parallel_3d
  type(parallel_3d_t), target, save :: mod_parallel_3d

  public :: init
  interface init
     module procedure parallel_3d_init
  endinterface

  public :: del
  interface del
     module procedure parallel_3d_del
  endinterface

  public :: allocate
  interface allocate
     module procedure parallel_3d_allocate
  endinterface

  public :: request_border
  interface request_border
     module procedure parallel_3d_request_border
  endinterface

  public :: communicate_particles
  interface communicate_particles
     module procedure parallel_3d_communicate_particles
  endinterface

  public :: communicate_ghosts
  interface communicate_ghosts
     module procedure parallel_3d_communicate_ghosts
  endinterface

  public :: communicate_forces
  interface communicate_forces
     module procedure parallel_3d_communicate_forces
  endinterface

  public :: register
  interface register
     module procedure parallel_3d_register
...
contains
  ...
  !<
  subroutine parallel_3d_init(this, p, decomposition, verlet_shell, error)
    implicit none

    type(parallel_3d_t), intent(inout)        :: this
  ...
  endsubroutine parallel_3d_init
  ...
  !! Allocate buffers
  !<
  subroutine parallel_3d_allocate(this, p)
    implicit none
    ...
    write (ilog, '(A)')  "- parallel_3d_allocate -"

    call log_memory_start("parallel_3d_allocate")
    ...
    call log_memory_stop("parallel_3d_allocate")
  ...
  endsubroutine parallel_3d_allocate
  ...
  !! Set the communication border
  !<
  subroutine parallel_3d_request_border(this, p, border, verlet_shell, error)
    implicit none
    ...
    write (ilog, '(A)')  "- parallel_3d_request_border -"
  ...
  endsubroutine parallel_3d_request_border

  
  !>
  !! Destructor
  !!
  !! Delete all parallel_3ds
  !<
  subroutine parallel_3d_del(this)
    implicit none
...
!       write (ilog, '(5X,A,3I5,9F20.10)')  "recv2: ", p%index(p%natloc), p%global2local(p%index(p%natloc)), p%Z(p%natloc), POS3(p, p%natloc), PNC3(p, p%natloc), off(:)
  ...
  !**********************************************************************
  subroutine parallel_3d_communicate_particles(this, p, error)
    implicit none
    ...
    call timer_start("parallel_3d_communicate_particles")
...
!                n_send_l = n_send_l + 1
    ...
    call timer_stop("parallel_3d_communicate_particles")

  endsubroutine parallel_3d_communicate_particles
...
!       endif
  ...
  ! the border.
  !**********************************************************************
  subroutine parallel_3d_communicate_ghosts(this, p, new_list, error)
    implicit none
    ...
    call timer_start("parallel_3d_communicate_ghosts")
    ...
    call timer_stop("parallel_3d_communicate_ghosts")

  endsubroutine parallel_3d_communicate_ghosts
  ...
  ! border size in BOPs.
  !**********************************************************************
  subroutine parallel_3d_communicate_forces(this, p, error)
    implicit none
    ...
    call timer_start("parallel_3d_communicate_forces")
    ...
    call timer_stop("parallel_3d_communicate_forces")

  endsubroutine parallel_3d_communicate_forces


  subroutine parallel_3d_register(this, cfg)
    use, intrinsic :: iso_c_binding

    implicit none

    type(parallel_3d_t), target, intent(inout)  :: this
  ...
  endsubroutine parallel_3d_register

endmodule parallel_3d
