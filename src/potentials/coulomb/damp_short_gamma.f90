...
! function hij(abs_rij, tau_i, tau_j, zeta) result(res)
...
! function part_deriv_hij_wrt_Ui(abs_rij, tau_i, tau_j, zeta) result(res)
! real(DP), intent(in) :: abs_rij
! real(DP), intent(in) :: tau_i, tau_j
! real(DP), intent(in) :: zeta
! real(DP)             :: U_i, U_j
...
! res     = - 0.50_DP*zeta*abs_rij**2*fact*hij(abs_rij, tau_i, tau_j, zeta)

! endfunction part_deriv_hij_wrt_Ui

! function part_deriv_hij_wrt_r(abs_rij, tau_i, tau_j, zeta) result(res)
! real(DP), intent(in) :: abs_rij
! real(DP), intent(in) :: tau_i, tau_j
! real(DP), intent(in) :: zeta
! real(DP)             :: U_i, U_j
...
! res     = - 2.0_DP*abs_rij*fact*hij(abs_rij, tau_i, tau_j, zeta)

! endfunction part_deriv_hij_wrt_r

! function second_part_deriv_hij_wrt_Ui_and_r(abs_rij, tau_i, tau_j, zeta) result(res)
! real(DP), intent(in) :: abs_rij
! real(DP), intent(in) :: tau_i, tau_j
! real(DP), intent(in) :: zeta
! real(DP)             :: U_i, U_j
...
! res     = zeta*abs_rij*fact1*(abs_rij**2*fact2 - 1.0_DP)*hij(abs_rij, tau_i, tau_j, zeta)
