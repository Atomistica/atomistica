...
!! ======================================================================
  ...
  type BOP_TYPE
     ...
     type(BOP_DB_TYPE)  :: db = Kumagai_CompMaterSci_39_457_Si  !< Parameterization
     ...
     real(DP)  :: cut_in_h2(KUMAGAI_MAX_PAIRS)    !< Outer cutoff squared
...
#define cut_ar_h  cut_out_h
     ...
     real(DP)  :: cut_bo_h(KUMAGAI_MAX_PAIRS)
     real(DP)  :: cut_bo_l(KUMAGAI_MAX_PAIRS)

     real(DP)  :: max_cut_sq(KUMAGAI_MAX_PAIRS)

     real(DP)  :: Cmin(KUMAGAI_MAX_PAIRS)
     real(DP)  :: Cmax(KUMAGAI_MAX_PAIRS)
     real(DP)  :: dC(KUMAGAI_MAX_PAIRS)
     real(DP)  :: C_dr_cut(KUMAGAI_MAX_PAIRS)
